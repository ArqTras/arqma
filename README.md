...
- [docs/ETN_A_C.md](docs/ETN_A_C.md) — ETN architecture (branch `ETF`)
- [docs/ETN_IMPLEMENTATION_PLAN.md](docs/ETN_IMPLEMENTATION_PLAN.md) — phased rollout
- [docs/ETN_OPERATOR.md](docs/ETN_OPERATOR.md) — runbooks
- [docs/ETN_RPC.md](docs/ETN_RPC.md) — HTTP / JSON-RPC reference
