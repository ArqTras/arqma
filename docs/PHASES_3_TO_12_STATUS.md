...
| 6 Messaging modules | In-repo CLI | identity, onion, swarm, envelope, `arqma-msg` (`gen` / `send <hex> hello` / `inbox` / `open` + stack env + remembered names) | Session-class client UX |
